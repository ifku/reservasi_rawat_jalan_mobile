...
import 'package:reservasi_rawat_jalan_mobile/data/data_sources/remote/clinic_remote_datasource.dart';
...
Future<void> setupServiceLocator() async {
  /*Network*/
  locator.registerSingleton<Dio>(DioClient("${dotenv.env['API_BASE_URL']}").create());
