...
class RRJThemeData {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      colorScheme: const ColorScheme.light(
        ...
        /*Surface*/
        surface: RRJColors.background,
        onSurface: RRJColors.blue900,
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: const ColorScheme.dark(
      ...
      background: RRJColors.blue700,
      onBackground: RRJColors.blue200,
      scrim: RRJColors.black,
      shadow: RRJColors.black,
      /*Surface*/
      surface: RRJColors.blue700,
      onSurface: RRJColors.blue200,
      surfaceVariant: RRJColors.grey700,
      surfaceTint: RRJColors.blue200,
      inverseSurface: RRJColors.azure300,
      onInverseSurface: RRJColors.blue900,
      onSurfaceVariant: RRJColors.grey200,
      /*Primary*/
      primary: RRJColors.blue500,
      onPrimary: RRJColors.blue200,
      primaryContainer: RRJColors.blue700,
      onPrimaryContainer: RRJColors.azure200,
      inversePrimary: RRJColors.blue500,
      /*Secondary*/
      secondary: RRJColors.teal500,
