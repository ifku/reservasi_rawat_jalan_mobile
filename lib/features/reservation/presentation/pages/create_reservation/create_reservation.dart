...
class CreateReservationPage extends StatefulWidget {
  const CreateReservationPage({super.key, required this.doctor});
...
class _CreateReservationPageState extends State<CreateReservationPage> {
  ...
  void initState() {
    super.initState();
    _dateController.text = DateFormatter.formatDateTime(DateTime.now());
