...
import 'package:reservasi_rawat_jalan_mobile/core/components/card/rrj_doctor_schedule_card.dart';
import 'package:reservasi_rawat_jalan_mobile/core/components/card/rrj_menu_item_card.dart';
import 'package:reservasi_rawat_jalan_mobile/core/components/card/rrj_news_card.dart';
...
import 'package:reservasi_rawat_jalan_mobile/features/home/presentation/widgets/home_menu_item_data.dart';
                ...
                BlocBuilder<HomeBloc, HomeState>(
                  builder: (context, state) {
                    if (state is HomeSuccess) {
                      return Text(
                        "${LocaleKeys.homeScreen_halo.tr()}, ${state.user.userName}",
